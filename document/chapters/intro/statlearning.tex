...
probabilistic matching method \cite{tamu_method}. \todo[inline]{is this the
proper classification for TAMU work?}
...
characteristic. \todo[inline]{this isn't quite right -- figure out how to rephrase}
