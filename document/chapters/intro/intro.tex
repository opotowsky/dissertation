...
In the pre-detonation realm, this project focuses on statistical methods to
...
\begin{enumerate}
  \item The \textbf{reactor type} is classified as one of the three most common
        ...
        These three are chosen in order to simplify the nature of this 
        exploratory study, and there are several reactor types excluded.
        \todo{Paul check. BL wanted a little more context here}
...
Preventing nuclear terrorism is important work that has relevance along the
