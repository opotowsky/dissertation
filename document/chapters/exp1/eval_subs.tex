...
training set size.  \todo[inline]{Shoudl it be noted that the standard
deviation of the relative errors is large enough for all three curves that the
trend cannot be taken as proof?}
...
There is similar work being done \todo{get tamu citation} to this work that
...
performance differences can be looked at in more detail.  \todo[inline]{5\%
error case is shown but it follows a similar trend to 1\% rand err case.
Haven't done calcs for higher errors, but could.}
