...
\begin{figure}[!htb]
\todo[inline]{ch 4 uses more than relative error, and so added MAE this
section. need to add discussion.}
  \centering
  \begin{subfigure}[b]{0.49\textwidth}
    \centering
  ...
  \begin{subfigure}[b]{0.49\textwidth}
    ...
    \label{fig:randmaeC}
  \end{subfigure}
  \caption{Prediction performance of burnup, enrichment, and time since 
           irradiation as measured by \gls{MAE} with respect to decreasing 
           information quality in the form of uniform/random error applied 
           to the nuclide mass measurements in the training set.}
  \label{fig:randmae}
\end{figure}
