...
\todo[inline]{reduce verbosity and detail of summary, and add more firm conclusions}
...
\todo[inline]{Paul brought up the upper bound performance of MLL since the test
case is removed. but 20\% of training set is removed for scikit preds, so at
least for $k=1$ the upper bound is potentially worse for kNN}
