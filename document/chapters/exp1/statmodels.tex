...
\todo[inline]{warning: it appears you don't discuss training set scaling and 
you need to}
...
\ref{eq:loglike} is performed between the test sample and all the rows of the
training set.  The observation with the largest log-likelihood is returned as
the predicted labels. Just like with the scikit-learn algorithm-based
