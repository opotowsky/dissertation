...
folds and they all performed similarly because the training set is large.
Given the equal performance among several options, the number of \gls{CV} folds
was chosen to be 5 based on computational expediency. The \texttt{KFold}
...
of classes in the training database.  \todo[inline]{show quickly how they
performed} 
