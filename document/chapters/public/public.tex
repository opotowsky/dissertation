...
\begin{figure}[!htb]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=0.7\linewidth]{./chapters/public/intro.png}}
...
\begin{figure}[!htb]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=0.8\linewidth]{./chapters/public/nukemetaphor.png}}
...
\begin{figure}[H]
  \centering
  \makebox[\textwidth][c]{\includegraphics[height=0.75\textheight]{./chapters/public/ml-workflow.png}}
...
\begin{figure}[H]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=0.7\linewidth]{./chapters/public/path.png}}
...
\noindent \fcolorbox{gray!10}{gray!10}{
  \begin{minipage}[t]{0.45\textwidth}
    ...
    \begin{figure}[H]
      \centering
      \makebox[\textwidth][c]{\includegraphics[width=0.85\linewidth]{./chapters/public/gamma_spec.jpg}}
...
\noindent \fcolorbox{gray!10}{gray!10}{
  \begin{minipage}[t]{0.45\textwidth}
    ...
    \begin{figure}[H]
      \centering
      \makebox[\textwidth][c]{\includegraphics[width=0.85\linewidth]{./chapters/public/mass_spec.jpg}}
