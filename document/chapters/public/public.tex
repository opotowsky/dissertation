...
\begin{figure}[!htb]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=0.7\linewidth]{./chapters/public/intro.jpg}}
...
\begin{figure}[!htb]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=0.88888888\linewidth]{./chapters/public/nukemetaphor.jpg}}
...
\begin{figure}[H]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=0.85\linewidth]{./chapters/public/nf-workflow.jpeg}}
...
\begin{figure}[H]
  \centering
  \makebox[\textwidth][c]{\includegraphics[height=0.85\textheight]{./chapters/public/ml-workflow.jpeg}}
...
\href{https://towardsdatascience.com/introduction-to-machine-learning-for-beginners-eed6024fdb08}{\color{blue}this}!}
\footnotetext[6]{If you have intitutional access to journals,
\href{https://www.tandfonline.com/doi/full/10.1080/00295450.2017.1401442}{\color{blue}here's
...
\href{https://www.jeolusa.com/RESOURCES/Analytical-Instruments/Mass-Spectrometry-Basics}{\color{blue}This
...
\begin{figure}[H]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=0.9\linewidth]{./chapters/public/path.jpg}}
...
\noindent \fcolorbox{gray!10}{gray!10}{
  \begin{minipage}[t]{0.45\textwidth}
    ...
    to be protected against radiation and take the sample out of its packaging
    to get the best measurements possible. They let the detector measure the
    sample for 10 minutes, et voil\`{a}: a gamma spectrum of the sample. Our
    friend then took the gamma spectrum and compared it against their
    machine-learned model that was created using a training set composed of
    $450,000$ simulated gamma spectra of different types of nuclear fuel. And 
    out popped an answer: \\
...
\noindent \fcolorbox{gray!10}{gray!10}{
  \begin{minipage}[t]{0.45\textwidth}
    ...
    in the nuclear fuel sample to high precision! Now they were ready to borrow
    our friend's machine learning method to predict the parameters of the
...
\fcolorbox{gray!10}{gray!10}{
  \begin{minipage}[t]{0.45\textwidth}
    ...
    Republic of Thoria (DPRT). This made sense to everyone because the DPRT had
    been a threat for some time. Everyone knew their missiles couldn't get to
    the UFU, so they must have concocted a different plan.
...
\fcolorbox{gray!10}{gray!10}{
  \begin{minipage}[t]{0.45\textwidth}
    ...
    authorities specializing in worldwide reactor operational history databases
    were able to determine this came from a reactor in \ldots GASP! The
    Commonwealth of Puerto Plutonio, a Territory of the UFU?! This made no
...
\begin{figure}[H]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=0.85\linewidth]{./chapters/public/theend.jpg}}
