...
\todo[inline]{anomalous auto list knn cases for d1 and d2 exist for all four
prediction parameters. the same discussion is therefore relevant for all four
(that the auto method is likely picking up peaks for the HPGes that are adding
noise and not information to the windows lists). where to put this? Here, then
