...
increases from about 5\% to about 10\% from the 12-nuclide set to the 7-nuclide
set. For the 7-nuclide set decision trees classification, the misclassification
of \gls{PHWR}s as \gls{BWR}s reaches about 5\%. By contrast, the same
misclassification is 3\% for \textit{k}-nearest neighbors and 1\% for \gls{MLL}
calculations. 
