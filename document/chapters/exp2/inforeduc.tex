...
quality is needed to train an \todo{edit doc for a/an w/ aconryms} \gls{ML}
...
amount to be smuggled, it would overwhelm a detector at the \todo{default?}
...
sure variables are explained clearly, chose r to match previous variables/the
