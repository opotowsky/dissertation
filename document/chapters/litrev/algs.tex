...
\begin{figure}[!htb]
  ...
  \caption[Example of a decision tree]
          {Example of a decision tree process, where maximum tree depth is 
           limited to 3.}
\todo[inline]{BL: as this is a white box method it would be possible to draw
physical insight into what is going on. E.g., the Sm being low indicates either
a low fission cross section or a high Sm cross-section - possibly the most
thermalized samples. (PHWR or the bottom of a BWR stack?) Pu239 is then burnup
related giving the PHWR/BWR split. It is less clear at first glance what is
going on with Am242. AO: address this after prev todo} 
  \label{fig:dtr}
\end{figure}
