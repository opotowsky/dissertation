...
\todo[inline]{Check on text flow here, since a chunk was moved to intro} 

\subsection{Nuclear Forensics as an Inverse Problem}
\label{sec:inverse}

\todo[inline]{probably not relevant anymore, and definitely would need better 
              explanation if kept in. Its possibly useful way to frame the problem. 
              Also haven't double checked that Bayes explanation is correct yet.}
