...
\begin{figure}[!htb]
  \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{./chapters/litrev/SupervisedRegression.png}}
  \caption[Schematic of supervised machine learning process]
          {Diagram of a supervised machine learning process: a model 
...
\textit{instances}, or rows of \textit{samples}, commonly referred to as
\textit{entries} later in this work.  Each entry has some \textit{attributes},
also referred to as \textit{features}. It also has a \textit{label}, which can
be a categorical label or discrete/continuous values.  
...
and validated, it is finalized; then a user can provide a single test sample
