%%%
%this section is copy-pasted and includes CV error introduction
%%%
Next, the \textit{training
...
application of which is discussed below in Section mmmmmm.
