...
\todo[inline]{fix adjusted sample weight equation and maybe take w\_j 
out since that is class weight and isn't used here}
\begin{equation}
...
misclassifications).  \todo[inline]{fix plural acro situation here}
