...
\begin{figure}[!htb]
  ...
  \caption[Illustration of cross validation]
   ...
   \todo[inline]{BL: This diagram is confusing because testing, CV and training are 
   different sizes at the top and smaller sizes below. You might want to draw this 
   diagram with k=5 and then the CV and testing bars can both be 20\% in top pic}
  \label{fig:cverror}
\end{figure}
