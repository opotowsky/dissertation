...
\newcommand\@thesistitlemedskip{0.2in} %was 3
\newcommand\@thesistitlebigskip{0.4in} %was 5
...
\gdef\@defensedate{Day Month 2021}
\gdef\@committee{
  \setstretch{1.0}
  \footnotesize
  Sunil S. Chirayath, Professor, Nuclear Engineering, Texas A\&M University\\
  Douglass L. Henderson, Professor, Nuclear Engineering \& Engineering Physics\\
  Benjamin Lindley, Professor, Nuclear Engineering \& Engineering Physics\\
...
%-----------------------------------------------------------------------------
    ...
    \begin{center}
      ...
      \\[\@thesistitlebigskip]
    \end{center}
    \hspace*{-0.7in}Date of final oral examination: \@defensedate \\[\@thesistitlesmallskip]
    \hspace*{-0.7in}{\small Oral Examination Committee:}\\
    \@committee
  \end{titlepage}
