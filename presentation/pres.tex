...
\title[Impacts of Information Reduction SNF Attribution]
      {\large Spent Nuclear Fuel Attribution using Statistical Methods: 
       \normalsize Impacts of Information Reduction on Prediction Performance}
%\subtitle[short subtitle]{long subtitle}
\subtitle[PhD Defense]{\vspace{4mm} PhD Defense}
%\author[short name]{long name}
\author[A. Opotowsky]{Arrielle Opotowsky}
%\date[short date]{long date}
\date[08.16.2021]{16 August 2021}
